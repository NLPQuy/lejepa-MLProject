...
SOURCE = "/kaggle/input/datasets/phamphuhoa/lejepa7/lejepa-MLProject"       # ← adjust to your uploaded dataset name
...
# !python {BENCH}/lejepa-vit-small.py \
#     --backbone vit_small_patch16_224 --max_epochs 100 --batch_size 128 --num_workers 4 \
#     --data_local_path {DATA} --checkpoint_dir {CKPT}/baseline-vits --no_wandb 
