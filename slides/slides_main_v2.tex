...
\[
  ...
  = \underbrace{\textcolor{mbad}{(1-\lambda)\cdot\mathcal{L}_{\rm pred}}}_{\displaystyle\textcolor{mbad!80!black}{\text{views phải agree}}}
  \;+\;
  \underbrace{\textcolor{mgood}{\lambda\cdot\text{SIGReg}}}_{\displaystyle\textcolor{mgood!80!black}{\text{push về }\mathcal{N}(\mathbf{0},I)}}
\]
{\scriptsize\color{mgray} Khuyến nghị: $\lambda \approx 0.05$}
\end{center}
...
\resizebox{\linewidth}{!}{%
\footnotesize
\begin{tabular}{@{}l c c >{\columncolor{mgood!12}}c@{}}
\toprule
...
Stop-gradient     & \textcolor{mbad}{\xmark}  & \textcolor{mbad}{\xmark}   & \textcolor{mgood}{\textbf{\cmark}} \\
Teacher-student   & \textcolor{mbad}{\xmark}  & \textcolor{mbad}{\xmark}   & \textcolor{mgood}{\textbf{\cmark}} \\
