...
# %% [markdown]
# # LeJEPA Ablation - Projector Architecture
# - **Spec key**: `projector_depth`
...
paths = setup_kaggle_env(source=SOURCE, hf_cache=HF_CACHE, spec_key="projector_depth")
...
command = render("projector_depth", OVERRIDES)
print("# Configs: 4")
...
# %% [6] Dump CSV summary
# !python -m stable_pretraining.cli dump-csv-logs {paths['log_dir']} ablation_projector_depth max
