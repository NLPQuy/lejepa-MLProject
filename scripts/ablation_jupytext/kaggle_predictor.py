...
# %% [markdown]
# # LeJEPA Ablation - Predictor Head
# - **Spec key**: `predictor`
...
paths = setup_kaggle_env(source=SOURCE, hf_cache=HF_CACHE, spec_key="predictor")
...
command = render("predictor", OVERRIDES)
print("# Configs: 3")
...
# %% [6] Dump CSV summary
# !python -m stable_pretraining.cli dump-csv-logs {paths['log_dir']} ablation_predictor max
