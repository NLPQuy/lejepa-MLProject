...
# %% [markdown]
# # LeJEPA Ablation - Drop Path Rate
# - **Spec key**: `drop_path`
...
paths = setup_kaggle_env(source=SOURCE, hf_cache=HF_CACHE, spec_key="drop_path")
...
command = render("drop_path", OVERRIDES)
print("# Configs: 5")
...
# %% [6] Dump CSV summary
# !python -m stable_pretraining.cli dump-csv-logs {paths['log_dir']} ablation_drop_path max
