...
# %% [markdown]
# # LeJEPA Ablation - Number of Views
# - **Spec key**: `views`
...
paths = setup_kaggle_env(source=SOURCE, hf_cache=HF_CACHE, spec_key="views")
...
command = render_chunk("views", OVERRIDES, CHUNK_INDEX, CHUNK_SIZE)
print(f"# views chunk {CHUNK_INDEX}/{NUM_CHUNKS - 1} of 11 total configs")
...
# %% [6] Dump CSV summary
# !python -m stable_pretraining.cli dump-csv-logs {paths['log_dir']} ablation_views max
