...
# %% [markdown]
# # LeJEPA Ablation - Patch Masking Ratio
# - **Spec key**: `patch_masking`
...
paths = setup_kaggle_env(source=SOURCE, hf_cache=HF_CACHE, spec_key="patch_masking")
...
command = render("patch_masking", OVERRIDES)
print("# Configs: 6")
...
# %% [6] Dump CSV summary
# !python -m stable_pretraining.cli dump-csv-logs {paths['log_dir']} ablation_patch_masking max
